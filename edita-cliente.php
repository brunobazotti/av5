                    ...
                    <div class="row">
                        <div class="card mb-4">
                            <div class="card-header">
                                <h3 class="card-title">Edita Cliente :: <?php echo $cliente["id"]." | ".$cliente["nome"]; ?></h3>
                            </div> <!-- /.card-header -->
                            <div class="card-body">
                            <form action="edita-cliente.php?id=<?php echo $cliente['id']?>" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="endereco" name="endereco" 
                                            class="form-control" 
                                            required><?php echo htmlspecialchars($cliente['endereco']); ?></textarea>
                                        <div class="invalid-feedback">
                                            Por favor, insira um endereço para o cliente.
                                        </div>
                                    </div>
                                    <!-- Campo Data -->
                                    <div class="mb-3">
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary">Salvar</button>
                                         <!-- Botão Excluir -->
                                        <a href="exclui-cliente.php?id=<?php echo htmlspecialchars($cliente['id']); ?>" 
