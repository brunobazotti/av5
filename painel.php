...
try {
    // Contar registros na tabela `usuarios`
    $stmt = $pdo->query("SELECT COUNT(*) AS total FROM produtos");
    $totalProdutos = $stmt->fetchColumn();

    // Contar registros na tabela `login`
    $stmt = $pdo->query("SELECT COUNT(*) AS total FROM login");
    $totalUsuarios = $stmt->fetchColumn();

    // Contar registros na tabela `clientes`
                ...
                <div class="container-fluid"> <!--begin::Row-->
                    ...
                    <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 1-->
                            <div class="small-box text-bg-primary">
                                ...
                                </svg> <a href="lista-produtos.php" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                    Mais info <i class="bi bi-link-45deg"></i> </a>
                        ...
                        <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 2-->
                            <div class="small-box text-bg-success">
                                ...
                                </svg> <a href="lista-clientes.php" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                    Mais info <i class="bi bi-link-45deg"></i> </a>
                        ...
                        <div class="col-lg-3 col-6"> <!--begin::Small Box Widget 3-->
                            <div class="small-box text-bg-warning">
                                ...
                                </svg> <a href="lista-usuarios.php" class="small-box-footer link-dark link-underline-opacity-0 link-underline-opacity-50-hover">
                                    Mais info <i class="bi bi-link-45deg"></i> </a>
