                        ...
                        for($i=0;$i<$qtd_cli;$i++) {
                                   echo $linha = "<tr class=\"align-middle\">
                                            ...
                                            <td class=\"text-center\">
                                                ...
                                                <a href=\"exclui-cliente.php?id=".$listaClientes[$i]["id"]."\" class=\"btn btn-danger btn-sm\" title=\"Excluir\" onclick=\"return confirm('Tem certeza de que deseja excluir este produto?');\">
